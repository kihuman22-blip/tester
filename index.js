...
(function() {
  ...
  function createInfoHotspotElement(hotspot) {
    ...
    // Wir prüfen jetzt auf den Namen "Pizza" und entfernen Leerzeichen
    if (hotspot.title && hotspot.title.trim() === "Pizza") {
      wrapper.addEventListener('click', function() {
    ...
    var toggle = function() {
      // Wenn es die Pizza ist, soll das Standard-Marzipano-Fenster NICHT öffnen
      if (hotspot.title && hotspot.title.trim() === "Pizza") {
          return; 
      }
